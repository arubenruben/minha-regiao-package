...
from extract_election_files.Settings import settings
...
from extract_election_files.sub_flows.parliament_elections.ParliamentElections import (
    parliament_elections,
)
from extract_election_files.sub_flows.presidential_elections.PresidentialElections import (
    presidential_elections,
)
from extract_election_files.sub_flows.regional_elections.RegionalElections import (
    regional_elections,
)
from extract_election_files.sub_flows.town_hall_elections_files.TownHallElections import (
    town_hall_elections,
)
