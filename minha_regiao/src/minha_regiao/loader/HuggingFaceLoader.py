...
class HuggingFaceLoader(Generic[RecordT]):
    """Builds a Hugging Face `datasets.Dataset` from pydantic records and
    pushes it to the Hub. This is the canonical implementation -- it used
    to live as `extract_geo.services.DatasetPublisher.DatasetPublisher`,
    which now re-exports this class for backward compatibility.
    """
